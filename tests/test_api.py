...
async def _make_client(session: aiohttp.ClientSession) -> PorkbunClient:
    return PorkbunClient(session, API_KEY, SECRET_KEY)


async def test_ping_success(mock_api: aioresponses) -> None:
...
async def test_ping_auth_error(mock_api: aioresponses) -> None:
...
async def test_ping_network_error(mock_api: aioresponses) -> None:
...
async def test_get_records_success(mock_api: aioresponses) -> None:
...
async def test_get_records_with_subdomain(mock_api: aioresponses) -> None:
...
async def test_get_records_empty(mock_api: aioresponses) -> None:
...
async def test_create_record(mock_api: aioresponses) -> None:
...
async def test_create_record_with_subdomain(mock_api: aioresponses) -> None:
...
async def test_edit_record_by_name_type(mock_api: aioresponses) -> None:
...
async def test_edit_record_with_subdomain(mock_api: aioresponses) -> None:
...
async def test_api_error(mock_api: aioresponses) -> None:
